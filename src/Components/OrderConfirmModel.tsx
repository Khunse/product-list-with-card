...
export default function OrderConfirmModel({show,onClose,newOrder} : {show: boolean, newOrder: () => void,onClose: () => void})
{
    ...
    return (
        <Model show={show} onClose={onClose}>
            ...
            <div>
                <h1 className="font-bold text-3xl w-2/4">Order Confirmed</h1>
                <p className=" text-gray-400">We hope you enjoy your food!</p>
            </div>
            <OrderList />
            <button className="w-full rounded-3xl py-3 bg-orange-700 text-white font-semibold" onClick={newOrderHandler}>
                        Start New Order
            </button>
        </Model>
    )
        ...
        <div className="bg-white rounded-md">
            {
                ...
                <div className="flex flex-col items-center gap-5 border border-red-600-">
                    {/* <img src="" alt="" /> */}
                ...
                :
                <div className="px-5 bg-gray-100 rounded-t-lg">
                    {
                        cartItem.items.map(w => {
                            
                         return <div className="flex items-center py-5  border-b gap-3">
                            <img className="rounded-lg w-16 h-16 object-cover" src={w.image} alt={w.itemName} />
                            <div className="flex flex-col gap-2 text-nowrap w-40 flex-grow">

                                    <h1 className="font-semibold overflow-hidden overflow-ellipsis">{w.itemName}</h1>
                                ...
                                <h1 className="">${w.totalItemPrice.toFixed(1)}</h1>
                    ...
                    <div className="py-5 flex justify-between items-center px-5 bg-gray-100 rounded-b-lg">
